// Package gossip is a simple implementation of a gossip protocol for p2plib. It keeps track of a cache of messages
...
// Handle implements p2plib.Protocol and handles gossip.Message messages.
...
func (p *Protocol) hash(id p2plib.ID, data []byte) []byte {
