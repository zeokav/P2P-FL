// Package p2plib is an opinionated, easy-to-use P2P network stack for decentralized applications, and
// cryptographic protocols written in Go.
//
// p2plib is made to be minimal, robust, developer-friendly, performant, secure, and cross-platform across
...
type Protocol struct {
	...
	// completes p2plib's protocol handshake.
